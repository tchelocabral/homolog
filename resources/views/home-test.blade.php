            ...
            <div class="nav-tabs-custom nav-dashboard margemT50">
               <h1 class="titulo-principal texto-esquerda  titulo-lista-dash">{{ __('messages.Projetos') }}</h1>
                ...
                <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
                    <li class="active in">
                        <a data-toggle="tooltip" href="#lista" aria-expanded="true" class="nav-link" id="imagens-tab" aria-selected="false" title="{{ __('messages.Listas') }}"> <i class="fa fa-list" aria-hidden="true"></i></a>
                    </li>
                    <li >
                        <a data-toggle="tooltip" href="#card" aria-expanded="true" class="nav-link" id="imagens-tab" aria-selected="false" title="{{ __('messages.Cards') }}"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
                    </li>
                    <li>
                        <a data-toggle="tooltip" href="#detalhes" aria-expanded="true" class="nav-link" id="imagens-tab" title="{{ __('messages.Detalhes') }}" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
                    </li>
                </ul>
        ...
        @else      
                                        ...
                                        <div class="col-md-3 col-lg-3 col-sm-12 "> 
                                            <div class="box-group" id="accordion">
                                                <div class="panel box box-success com-shadow">
                                                    ...
                                                    <div class="col-md-6 displayFlex flexCentralizado flexEnd margemT10">
                                                        <img 
            ...
            @if($projetos_andamento && $total_proj_and>0)
                <div class="nav-tabs-custom nav-dashboard margemT50">
                   <h1 class="titulo-principal texto-esquerda titulo-lista-dash">
                        ...
                        <span class="accordion-marc"><i class="fa fa-angle-right"></i></span> {{ __('messages.Projetos em Andamento') }} 
                        </a>
                    </h1>
                    ...
                    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
                        ...
                        <li>
                            <a data-toggle="tooltip" href="#detalhes" aria-expanded="true" class="nav-link fundo-azul" id="imagens-tab" title="{{ __('messages.Detalhes') }}" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
                        </li>
                    </ul>
            ...
            @if($total_proj_coo>0)
                <div class="nav-tabs-custom nav-dashboard margemT50">
                   <h1 class="titulo-principal texto-esquerda titulo-lista-dash">
                    ...
                    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
                        <li class="active in">
                            <a data-toggle="tooltip" href="#listaProjCoord" aria-expanded="true" class="nav-link " id="imagens-tab" aria-selected="false" title="{{ __('messages.Listas') }}"> <i class="fa fa-list" aria-hidden="true"></i></a>
                        </li>
                        <li >
                            <a data-toggle="tooltip" href="#cardProjCoord" aria-expanded="true" class="nav-link" id="imagens-tab" aria-selected="false" title="{{ __('messages.Cards') }}"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
                        </li>
                        <li>
                            <a data-toggle="tooltip" href="#detalhesProjCoord" aria-expanded="true" class="nav-link" id="imagens-tab" title="{{ __('messages.Detalhes') }}" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
                        </li>
                    </ul>
            ...
            @if($jobs_parados && $total_jobs_par>0)
                <div class="nav-tabs-custom nav-dashboard margemT50">
                    ...
                    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
                        <li class="active in">
                            <a data-toggle="tooltip" href="#listaJobsParado" aria-expanded="true" class="nav-link fundo-vermelho" id="imagens-tab" aria-selected="false" title="{{ __('messages.Listas') }}"> <i class="fa fa-list" aria-hidden="true"></i></a>
                        </li>
                        <li >
                            <a data-toggle="tooltip" href="#cardJobsParado" aria-expanded="true" class="nav-link fundo-vermelho" id="imagens-tab" aria-selected="false" title="{{ __('messages.Cards') }}"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
                        </li>
                        <li>
                            <a data-toggle="tooltip" href="#detalhesJobsParado" aria-expanded="true" class="nav-link fundo-vermelho" id="imagens-tab" title="{{ __('messages.Detalhes') }}" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
                        </li>
                    </ul>
            ...
            @if($total_jobs_coo > 0)
                <div class="nav-tabs-custom nav-dashboard margemT50">
                    <h1 class="titulo-principal texto-esquerda titulo-lista-dash">
                        <a class="larguraTotal alturaTotal texto-preto" data-toggle="collapse" data-target="#collapsejobcoord" aria-expanded="false" aria-controls="#collapsejobcoord" role="button"> <span class="accordion-marc"><i class="fa fa-angle-right"></i></span> Jobs que Coordena</a>
                    </h1>
                    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
                        <li class="active in">
                            <a data-toggle="tooltip" href="#listaJobCoordena" aria-expanded="true" class="nav-link fundo-laranja" id="imagens-tab" aria-selected="false" title="{{ __('messages.Listas') }}"> <i class="fa fa-list" aria-hidden="true"></i></a>


                        </li>
                        <li >
                            <a data-toggle="tooltip" href="#cardJobCoordena" aria-expanded="true" class="nav-link fundo-laranja" id="imagens-tab" aria-selected="false" title="{{ __('messages.Cards') }}"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
                        </li>
                        <li>
                            <a data-toggle="tooltip" href="#detalhesJobCoordena" aria-expanded="true" class="nav-link fundo-laranja" id="imagens-tab" title="{{ __('messages.Detalhes') }}" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
                        </li>
                    </ul>
            ...
            @if($total_jobs_ava > 0)
                <div class="nav-tabs-custom nav-dashboard margemT50">
                    ...
                    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
                        <li class="active in">
                            <a data-toggle="tooltip" href="#listaJobsAvaliando" aria-expanded="true" class="nav-link" id="imagens-tab" aria-selected="false" title="{{ __('messages.Listas') }}"> <i class="fa fa-list" aria-hidden="true"></i></a>
                        </li>
                        <li >
                            <a data-toggle="tooltip" href="#cardJobsAvaliando" aria-expanded="true" class="nav-link" id="imagens-tab" aria-selected="false" title="{{ __('messages.Cards') }}"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
                        </li>
                        <li>
                            <a data-toggle="tooltip" href="#detalhesJobsAvaliando" aria-expanded="true" class="nav-link" id="imagens-tab" title="{{ __('messages.Detalhes') }}" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
                        </li>
                    </ul>
            ...
            @if($total_jobs_exe>0)
                <div class="nav-tabs-custom nav-dashboard margemT50">
                    ...
                    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
                        <li class="active in">
                            <a data-toggle="tooltip" href="#listaJobsExecutando" aria-expanded="true" class="nav-link fundo-verde-escuro" id="imagens-tab" aria-selected="false" title="{{ __('messages.Listas') }}"> <i class="fa fa-list" aria-hidden="true"></i></a>
                        </li>
                        <li >
                            <a data-toggle="tooltip" href="#cardJobsExecutando" aria-expanded="true" class="nav-link fundo-verde-escuro" id="imagens-tab" aria-selected="false" title="{{ __('messages.Cards') }}"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
                        </li>
                        <li>
                            <a data-toggle="tooltip" href="#detalhesJobsExecutando" aria-expanded="true" class="nav-link fundo-verde-escuro" id="imagens-tab" title="{{ __('messages.Detalhes') }}" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
                        </li>
                    </ul>
            ...
            @if($total_jobs_and>0)
                <div class="nav-tabs-custom nav-dashboard margemT50">
                    ...
                    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
                        <li class="active in">
                            <a data-toggle="tooltip" href="#listaJobsExecutando" aria-expanded="true" class="nav-link fundo-laranja" id="imagens-tab" aria-selected="false" title="{{ __('messages.Listas') }}"> <i class="fa fa-list" aria-hidden="true"></i></a>
                        </li>
                        <li >
                            <a data-toggle="tooltip" href="#cardJobsExecutando" aria-expanded="true" class="nav-link fundo-laranja" id="imagens-tab" aria-selected="false" title="{{ __('messages.Cards') }}"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
                        </li>
                        <li>
                            <a data-toggle="tooltip" href="#detalhesJobsExecutando" aria-expanded="true" class="nav-link fundo-laranja" id="imagens-tab" title="{{ __('messages.Detalhes') }}" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
                        </li>
                    </ul>
            ...
            @if(2==1)
                @if($jobs_concluidos && $total_jobs_con>0)
                    <div class="nav-tabs-custom nav-dashboard margemT50">
                        ...
                        <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
                            <li class="active in">
                                <a data-toggle="tooltip" href="#listaJobsConcluido" aria-expanded="true" class="nav-link fundo-verde-escuro" id="imagens-tab" aria-selected="false" title="{{ __('messages.Listas') }}"> <i class="fa fa-list" aria-hidden="true"></i></a>
                            </li>
                            <li >
                                <a data-toggle="tooltip" href="#cardJobsConcluido" aria-expanded="true" class="nav-link fundo-verde-escuro" id="imagens-tab" aria-selected="false" title="{{ __('messages.Cards') }}"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
                            </li>
                            <li>
                                <a data-toggle="tooltip" href="#detalhesJobsConcluido" aria-expanded="true" class="nav-link fundo-verde-escuro" id="imagens-tab" title="{{ __('messages.Detalhes') }}" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
                            </li>
                        </ul>
            ...
            @if($total_jobs_rec>0)
                <div class="nav-tabs-custom nav-dashboard margemT50">
                    ...
                    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
                        <li class="active in">
                            <a data-toggle="tooltip" href="#listaJobsRecusado" aria-expanded="true" class="nav-link fundo-vermelho" id="imagens-tab" aria-selected="false" title="{{ __('messages.Listas') }}"> <i class="fa fa-list" aria-hidden="true"></i></a>
                        </li>
                        <li >
                            <a data-toggle="tooltip" href="#cardJobsRecusado" aria-expanded="true" class="nav-link fundo-vermelho" id="imagens-tab" aria-selected="false" title="{{ __('messages.Cards') }}"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
                        </li>
                        <li>
                            <a data-toggle="tooltip" href="#detalhesJobsRecusado" aria-expanded="true" class="nav-link fundo-vermelho" id="imagens-tab" title="{{ __('messages.Detalhes') }}" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
                        </li>
                    </ul>
