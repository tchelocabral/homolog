            ...
            <div class="row">
                ...
                <div class="col-md-12">
                        ...
                        <div class="box box-solid box-primary com-shadow paddingB40">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" readonly red id="conta_paypal" name="conta_paypal" class="form-control" required value="{{ $usuario_auth->conta_paypal ?? '' }}" />
                                </div>
                                ...
                                {{-- DADOS BANCARIOS --}}
                                    {{-- <div class="row div-item-form"> --}}
                                        ...
                                        {{-- Nome agencia --}}
                                        {{-- <div class="col-sm-12 col-md-6">
                                            <p class="detalhe-label"><b>{{(__'messages.Agência')}}</b></p>
                        ...
                        <div class="box box-solid box-primary com-shadow paddingB40">
                            ...
                            <div class="box-body">
                                <div class="col-md-12">
                                    ...
                                    <p class="detalhe-label"><b>CPF</b></p>
                                    <input type="text" readonly id="cpf" name="cpf" class="form-control cpf" required value="{{ $usuario_auth->cpf ?? '' }}" />
                                    <p class="detalhe-label"><b>{{__('messages.Data de Nascimento')}}</b></p>
                                    <input type="date" readonly name="data_nascimento" id="data_nascimento" class="form-control"  required value="{{ $usuario_auth->data_nascimento ? $usuario_auth->data_nascimento->format('Y-m-d') : '' }}"/>
                                    <p class="detalhe-label"><b>{{__('messages.País que nasceu')}}</b></p>
                                    <input type="text" readonly name="pais_nascimento" id="pais_nascimento" class="form-control"  required value="{{ $usuario_auth->pais_nascimento ?? '' }}"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box box-solid box-primary com-shadow paddingB40">
                            ...
                            <div class="box-body">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" readonly id="rua" name="logradouro" class="form-control" required value="{{ $usuario_auth->logradouro ?? '' }}" />
                                    <p class="detalhe-label"><b>{{__('messages.Cidade')}}</b></p>
                                    <input type="text" readonly name="cidade" id="cidade" class="form-control"  required value="{{ $usuario_auth->cidade ?? '' }}" /> 
                                    <p class="detalhe-label"><b>{{__('messages.País')}}</b></p>
                                    <input type="text" readonly name="pais" id="pais" class="form-control"  required value="{{ $usuario_auth->pais ?? '' }}"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <hr />
                            <a href="{{route('editar.conta.paypal')}}" class="btn btn-success pull-right">{{__('messages.Editar Conta')}}</a>
                        </div>
                            {{-- <button type="submit" class="btn btn-success pull-right">{{__('messages.Editar Conta')}}</button> --}}
                    </div>
                </div>
