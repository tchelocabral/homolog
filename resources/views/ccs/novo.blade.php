...
@section('content_header')
    {{ Breadcrumbs::render('novo centro custo') }}
@stop
...
@section('content')
    ...
    <div class="row largura90 centralizado">
        ...
        <form id="form-projeto" name="form-projeto" action="{{ route('centro-custo.store') }}" method="POST" enctype="multipart/form-data">

            @csrf
            <div class="row margemB40">
                <div class="col-md-8">
                    <h1 class="">Novo Centro de Custo</h1>
                </div>
            </div>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="box box-solid box-primary com-shadow">
                        <div class="box-header with-border th-ocean com-borda">
                            <h3 class="box-title">Preencha os campos com os dados do Centro de Custo</h3>
                        </div>
                        <div class="box-body">
                            <div class="col-md-12">
                                <h3 class="">Dados do Centro de Custo</h3>
                                <hr>
                                ...
                                <div class="row div-item-form">
                                    <div class="col-md-12">
                                        ...
                                        @else
                                            <input type="text" name="nome" id="nome" class="form-control" value="{{ $custo['nome'] or old('nome') }}" placeholder="" />
                                        @endisset
                                    </div>
                                    ...
                                    <div class="col-md-12 margemT10">
                                        ...
                                        @else
                                            <textarea id="descricao" name="descricao" class="form-control">{{ $custo['descricao']  or old('descricao') }}</textarea>
                                        @endisset
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="box-footer footer-com-padding">
                            <button type="submit" class="btn btn-success pull-right">Salvar Centro de Custo</button>
                        </div>
                    </div>
                </div>
            </div>
