...
@section('title', __('messages.Projetos em Andamento'))

@section('content_header')
        {{ Breadcrumbs::render('projeto andamento') }}
@stop
...
@section('content')
    ...
    <div class="row largura80 centralizado">
        <div class="col-md-12">
            <h1 class="margemB40">{{ __('messages.Lista de Projetos em Andamento') }}</h1>
            @unless($projetos->count())
                <p>{{ __('messages.Não Existem Projetos em Andamento') }}</p>
            @else
