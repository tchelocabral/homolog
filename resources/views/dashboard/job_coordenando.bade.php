<div class="nav-tabs-custom nav-dashboard margemT50">
    ...
    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
        <li class="active in">
            <a data-toggle="tooltip" href="#listaJobCoordena" aria-expanded="true" class="nav-link fundo-laranja" id="imagens-tab" aria-selected="false" title="Listas"> <i class="fa fa-list" aria-hidden="true"></i></a>
        </li>
        <li >
            <a data-toggle="tooltip" href="#cardJobCoordena" aria-expanded="true" class="nav-link fundo-laranja" id="imagens-tab" aria-selected="false" title="Cards"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
        </li>
        <li>
            <a data-toggle="tooltip" href="#detalhesJobCoordena" aria-expanded="true" class="nav-link fundo-laranja" id="imagens-tab" title="Detalhes" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
        </li>
    </ul>
                ...
                <table id="lista-dashboard-job-coord" class="table larguraTotal com-filtro-lista table-striped">
                    <thead class="">
                        <tr class="th-green">
                            ...
                            <th colspan="" class="box-title texto-branco padding12">Colaborador</th>
                            <th colspan="" class="box-title texto-branco padding12">Descrição</th>
                            <th class="box-title">Data de entrega</th>
                    ...
                    <tbody class="fundo-branco com-shadow">
                        @foreach($coordenando as $job)
                            <tr class="">
                                ...
                                <td class=" largura15">
                                    {{$job->created_at ? $job->created_at->format('d.m.Y') : 'Não informado'}}
                                </td>
                            ...
                            <th class="th-green texto-branco padding12 border-left">
                                <div class="panel-heading cor-personalizada" >
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <span class="pull-right titulo-tab-imagens" href="" class="" >Ação</span>
                                        </div>
                                    </div>  
                                </div>
                            </th>
                                    ...
                                    <div id="collapsjobaberto{{$job->id}}" class="collapse" aria-labelledby="panel-job-aberto-{{$job->id}}" data-parent="#img-accordion">
                                        <div class="panel-body">
                                            <div class="row margemB10">
                                                ...
                                                <div class="col-md-12">
                                                    <h4><b>Coordenador: </b> {{ $job->coordenador->nome ? $job->coordenador->nome :  __('messages.Não Informado')  }}</h4>
                                                </div>
                                                <div class="col-md-12">
                                                    <h4><b>Status: </b>
