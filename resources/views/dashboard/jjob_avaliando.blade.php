<div class="nav-tabs-custom nav-dashboard margemT50">
    ...
    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
        <li class="active in">
            <a data-toggle="tooltip" href="#listaJobsAvaliando" aria-expanded="true" class="nav-link" id="imagens-tab" aria-selected="false" title="Listas"> <i class="fa fa-list" aria-hidden="true"></i></a>
        </li>
        <li >
            <a data-toggle="tooltip" href="#cardJobsAvaliando" aria-expanded="true" class="nav-link" id="imagens-tab" aria-selected="false" title="Cards"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
        </li>
        <li>
            <a data-toggle="tooltip" href="#detalhesJobsAvaliando" aria-expanded="true" class="nav-link" id="imagens-tab" title="Detalhes" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
        </li>
    </ul>
                                    ...
                                    <div class="panel-heading cor-personalizada" id="panel-job-aberto-{{$job->id}}" style="background: #fff;">
                                        ...
                                        <div class="panel-body">
                                            <div class="row margemB10">
                                                ...
                                                <div class="col-md-12">
                                                    <h4><b>Coordenador: </b> {{ $job->coordenador->nome ? $job->coordenador->nome : 'Não Informado' }}</h4>
                                                </div>
                                                <div class="col-md-12">
                                                    <h4><b>Status: </b>
