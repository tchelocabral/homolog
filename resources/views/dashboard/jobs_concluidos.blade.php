<div class="nav-tabs-custom nav-dashboard margemT50">
    ...
    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
        <li class="active in">
            <a data-toggle="tooltip" href="#listaJobsConcluido" aria-expanded="true" class="nav-link fundo-verde-escuro" id="imagens-tab" aria-selected="false" title="Listas"> <i class="fa fa-list" aria-hidden="true"></i></a>
        </li>
        <li >
            <a data-toggle="tooltip" href="#cardJobsConcluido" aria-expanded="true" class="nav-link fundo-verde-escuro" id="imagens-tab" aria-selected="false" title="Cards"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
        </li>
        <li>
            <a data-toggle="tooltip" href="#detalhesJobsConcluido" aria-expanded="true" class="nav-link fundo-verde-escuro" id="imagens-tab" title="Detalhes" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
        </li>
    </ul>
                    ...
                    <table id="lista-dashboard-job-concluido" class="table table-striped larguraTotal com-filtro-lista">
                        <thead class="">
                            <tr class="th-green">
                                ...
                                <th colspan="" class="box-title texto-branco padding12 largura15">Colaborador</th>
