<div class="nav-tabs-custom nav-dashboard margemT50">
    <h1 class="margemT5 margemB5 titulo-principal texto-esquerda titulo-lista-dash">
        <a class="larguraTotal alturaTotal texto-preto" data-toggle="collapse" data-target="#collapsejobparado" aria-expanded="false" aria-controls="#collapsejobparado" role="button"><span class="accordion-marc"><i class="fa fa-angle-right"></i></span> Jobs Parados</a>
    </h1> 
    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
        <li class="active in">
            <a data-toggle="tooltip" href="#listaJobsParado" aria-expanded="true" class="nav-link fundo-vermelho" id="imagens-tab" aria-selected="false" title="Listas"> <i class="fa fa-list" aria-hidden="true"></i></a>
        </li>
        <li >
            <a data-toggle="tooltip" href="#cardJobsParado" aria-expanded="true" class="nav-link fundo-vermelho" id="imagens-tab" aria-selected="false" title="Cards"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
        </li>
        <li>
            <a data-toggle="tooltip" href="#detalhesJobsParado" aria-expanded="true" class="nav-link fundo-vermelho" id="imagens-tab" title="Detalhes" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
        </li>
    </ul>
