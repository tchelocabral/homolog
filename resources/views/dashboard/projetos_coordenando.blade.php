<div class="nav-tabs-custom nav-dashboard margemT50">
    ...
    <ul class="nav nav-tabs displayFlex flexEnd paddingR20" id="tabs-projeto" role="tablist">
        <li class="active in">
            <a data-toggle="tooltip" href="#listaProjCoord" aria-expanded="true" class="nav-link " id="imagens-tab" aria-selected="false" title="Listas"> <i class="fa fa-list" aria-hidden="true"></i></a>
        </li>
        <li >
            <a data-toggle="tooltip" href="#cardProjCoord" aria-expanded="true" class="nav-link" id="imagens-tab" aria-selected="false" title="Cards"><i class="fa fa-credit-card" aria-hidden="true"></i></a>
        </li>
        <li>
            <a data-toggle="tooltip" href="#detalhesProjCoord" aria-expanded="true" class="nav-link" id="imagens-tab" title="Detalhes" aria-selected="false"><i class="fa fa-info" aria-hidden="true"></i></a>
        </li>
    </ul>
                ...
                <table id="lista-dashboard-proj-coord" class="table table-striped larguraTotal com-filtro-lista com-shadow">
                    <thead>
                        <tr>
                            ...
                            <th colspan="" class="th-ocean texto-branco padding12">Projeto</th>
                            <th colspan="" class="th-ocean texto-branco padding12 largura15">Cliente</th>
                            <th colspan="" class="th-ocean texto-branco padding12 largura15">Criação</th>
                            <th colspan="" class="th-ocean texto-branco padding12 largura15">Previsão de Entrega</th>
                            <th colspan="" class="th-ocean texto-branco padding12">Progresso</th>
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" aria-expanded="false" >
                                        <div class="box-body">
                                            ...
                                            <div class="col-md-12 margemT20">
                                                ...
                                                {{$proj_and->data_previsao_entrega ? \Carbon\Carbon::parse($proj_and->data_previsao_entrega)->format('d.m.Y') : 'Não Informado'}}</p>
                                            </div>                                  
                                        </div>
                                    </div>
                                </div>
